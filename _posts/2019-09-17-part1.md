...
$A^+$ exists for any matrix ![A](https://wikimedia.org/api/rest_v1/media/math/render/
svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3), but, when the latter has full rank (that is, the rank of A is min(m,n)), then $A^+$ can be expressed as a simple algebraic formula A(m,n).
